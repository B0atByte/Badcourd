...
<style>
  * {
  ...
  ::view-transition-new(root) {
    animation: _slideIn 0.2s ease-out;
  }

  ::view-transition-old(root) {
    animation: _slideOut 0.15s ease-in;
  }
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between items-center h-14">
        ...
        <?php if ($hasAnyManagePerm): ?>
          <div class="relative" id="admin-dd-wrap">
            <button id="admin-dd-btn" type="button"
              ...
              จัดการ
              <svg id="admin-dd-chevron" class="w-3.5 h-3.5 transition-transform duration-200" fill="none"
            ...
            <div id="admin-dropdown">
              ...
              <?php endif; ?>
              <?php if (can('yoga_classes') || can('yoga_packages')): ?>
      ...
      <button id="mobile-menu-btn" type="button"
        class="md:hidden p-2 text-white rounded-lg hover:bg-white/10 transition-colors">
