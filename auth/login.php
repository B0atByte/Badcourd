...
{
    if ($c['court_type'] === 'vip' || $c['is_vip'] == 1)
        return $c['vip_room_name'] ?? 'ห้อง VIP';
...
<body style="background:#FAFAFA;" class="min-h-screen flex items-center justify-center p-4">
    ...
    <!-- ===== Timetable Modal ===== -->
    <div id="timetableModal" class="hidden fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-3"
                                            ...
                                            <div class="bk-item bk-vip">
                                                <div>
                                                    ...
                                                    <div class="opacity-80 text-xs mt-0.5">
                                                        <?= htmlspecialchars($det['customer_name']) ?></div>
                                                </div>
