...
if (!in_array($per_page, [0, 12, 24, 48, 100]))
    $per_page = 24;
                    ...
                    <div class="bg-white rounded-xl border border-gray-200 p-5 hover:shadow-md transition-shadow">
                        ...
                        <div class="space-y-2 mb-4">
                            ...
                            <div class="flex justify-between text-sm">
                                ...
                                <span
                                    class="font-semibold text-gray-900">฿<?= number_format($member['total_spent'], 0) ?></span>
                            </div>
                            <div class="flex justify-between text-sm">
                                <span class="text-gray-500">จำนวนครั้งที่จอง</span>
                                <span class="font-semibold text-gray-900"><?= number_format($member['total_bookings']) ?>
                                    ครั้ง</span>
                            </div>
                            <?php if ($discount > 0): ?>
                                <div class="flex justify-between text-sm">
