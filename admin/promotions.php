...
if (isset($_GET['added']))   $success = 'เพิ่มโปรโมชั่นสำเร็จ';
if (isset($_GET['deleted'])) $success = 'ลบโปรโมชั่นสำเร็จ';
  ...
  <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
    <div style="background:#005691;" class="px-5 py-3 flex justify-between items-center">
      ...
      <span class="text-blue-200 text-xs">
        พบ <?= number_format($totalRecords) ?> รายการ<?= ($search !== '' || $status_filter !== '') ? ' (กรองแล้ว)' : '' ?>
      </span>
    </div>
    ...
    <div class="block lg:hidden divide-y divide-gray-100">
      ...
      <div class="p-4">
        ...
        <div class="flex gap-2">
          ...
          <a href="?delete=<?= $p['id'] ?>"
             onclick="return confirm('ยืนยันลบโปรโมชั่น \"<?= htmlspecialchars($p['name'], ENT_QUOTES) ?>\"?')"
