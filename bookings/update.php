...
<body style="background:#FAFAFA;" class="min-h-screen">
    ...
    <div class="max-w-3xl mx-auto px-4 py-8">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-5 mb-5">
            <h3 style="color:#005691;" class="font-semibold mb-3 text-sm uppercase tracking-wide">ข้อมูลการจอง
                #<?= $booking['id'] ?></h3>
                ...
                <form method="post">
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="time" name="start_time" required value="<?= htmlspecialchars($currentTime) ?>"
                                min="06:00" max="23:00"
                                class="w-full px-3 py-2.5 rounded-lg border border-gray-300 focus:border-[#E8F1F5] focus:ring-2 focus:ring-[#E8F1F5]/20 outline-none text-sm">
                        ...
                        <div>
                            ...
                            <input type="number" name="hours" required min="1" max="6" value="<?= $currentHours ?>"
                                class="w-full px-3 py-2.5 rounded-lg border border-gray-300 focus:border-[#E8F1F5] focus:ring-2 focus:ring-[#E8F1F5]/20 outline-none text-sm">
                        </div>
                        ...
                        <div class="flex gap-3 pt-2">
                            ...
                            <a href="index.php" style="color:#004A7C; border-color:#E8F1F5;"
